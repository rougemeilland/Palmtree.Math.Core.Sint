...
EXTRN	PMC_SINT_Initialize:PROC
EXTRN	TEST_autogenerated_1:PROC
EXTRN	TEST_autogenerated_2:PROC
...
$LN10:
	...
	lea	rcx, OFFSET FLAT:__566B17FC_debug@c
	call	__CheckForDebuggerJustMyCode

; 137  :     if (__DEBUG_LOG != NULL)

	cmp	QWORD PTR __DEBUG_LOG, 0
	je	$LN6@DumpBinary

; 138  :     {
; 139  :         unsigned char* p = (unsigned char*)buf;

	mov	rax, QWORD PTR buf$[rbp]
	mov	QWORD PTR p$1[rbp], rax

; 140  :         count *= sizeof(__UNIT_TYPE);
...
; 71   :     PMC_SINT_ENTRY_POINTS* ep = PMC_SINT_Initialize(&conf);

	lea	rcx, QWORD PTR conf$[rbp]
	call	PMC_SINT_Initialize
...
; 73   :     {
; 74   :          env->log(L"SINT_Initialize failed\n");
...
; 95   :              ep->UINT_ENTRY_POINTS.PROCESSOR_FEATURE_POPCNT,
; 96   :              ep->UINT_ENTRY_POINTS.PROCESSOR_FEATURE_ADX,
; 97   :              ep->UINT_ENTRY_POINTS.PROCESSOR_FEATURE_BMI1,
; 98   :              ep->UINT_ENTRY_POINTS.PROCESSOR_FEATURE_BMI2,
; 99   :              ep->UINT_ENTRY_POINTS.PROCESSOR_FEATURE_ABM);
; 100  : 
...
; 59   :     TEST_autogenerated_1(env, ep);

	mov	rdx, QWORD PTR ep$[rbp]
	mov	rcx, QWORD PTR env$[rbp]
	call	TEST_autogenerated_1

; 60   :     TEST_autogenerated_2(env, ep);

	mov	rdx, QWORD PTR ep$[rbp]
	mov	rcx, QWORD PTR env$[rbp]
	call	TEST_autogenerated_2
...
; 130  :     static wchar_t buffer[256];
; 131  :     wsprintfW(buffer, format, return_value);
...
; 123  :     static wchar_t buffer[256];
; 124  :     wsprintfW(buffer, format, n1, n2);
