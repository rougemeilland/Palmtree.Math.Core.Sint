...
$LN6@TEST_Negat:
	...
	lea	rcx, OFFSET FLAT:??_C@_1CC@CMHDHNMP@?$AAN?$AAe?$AAg?$AAa?$AAt?$AAe?$AA_?$AAX?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF?$AAd@
...
$LN8@TEST_Negat:
	...
	lea	rcx, OFFSET FLAT:??_C@_1DI@EKCGPGLB@?$AAN?$AAe?$AAg?$AAa?$AAt?$AAe?$AA_?$AAX?$AAn?$PP?$KJ?$AA0?$PP?$LD?$PP?$PM?$PP?I?$AAL@
	call	FormatTestMesssage
