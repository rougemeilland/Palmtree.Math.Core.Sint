...
__07425A21_test_op_clone@c DB 01H
msvcjmc	ENDS
PUBLIC	TEST_Clone_X
PUBLIC	__JustMyCode_Default
PUBLIC	??_C@_1EC@NPMCAPKO@?$AAF?$AAr?$AAo?$AAm?$AAB?$AAy?$AAt?$AAe?$AAA?$AAr?$AAr?$AAa?$AAy?$AAn?$PP?$KJ@ ; `string'
PUBLIC	??_C@_1CA@CLLGGBHI@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF?$AAd?$AA?$CJ@ ; `string'
PUBLIC	??_C@_1DG@CCIPFPD@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AAn?$PP?$KJ?$AA0?$PP?$LD?$PP?$PM?$PP?I?$AAL?$AA?$BP@ ; `string'
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$TEST_Clone_X DD imagerel $LN13
	DD	imagerel $LN13+728
	DD	imagerel $unwind$TEST_Clone_X
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
CONST	ENDS
;	COMDAT ??_C@_1DG@CCIPFPD@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AAn?$PP?$KJ?$AA0?$PP?$LD?$PP?$PM?$PP?I?$AAL?$AA?$BP@
CONST	SEGMENT
??_C@_1DG@CCIPFPD@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AAn?$PP?$KJ?$AA0?$PP?$LD?$PP?$PM?$PP?I?$AAL?$AA?$BP@ DB 'C'
	DB	00H, 'l', 00H, 'o', 00H, 'n', 00H, 'e', 00H, '_', 00H, 'X', 00H
	DB	'n0', 0a9H, '_0^', 0b3H, '0', 0fcH, '0', 0c9H, '0L0', 01fH, 'g'
	DB	085H, '_', 01aH, 090H, 08aH, '0g0o0j0D0(', 00H, '%', 00H, 'd', 00H
	DB	')', 00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1CA@CLLGGBHI@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF?$AAd?$AA?$CJ@
CONST	SEGMENT
??_C@_1CA@CLLGGBHI@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF?$AAd?$AA?$CJ@ DB 'C'
	DB	00H, 'l', 00H, 'o', 00H, 'n', 00H, 'e', 00H, '_', 00H, 'X', 00H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$TEST_Clone_X DD 025054a19H
	DD	011d2322H
	DD	07016005bH
	DD	05015H
...
;	COMDAT CONST
CONST	SEGMENT
TEST_Clone_X$rtcName$0 DB 078H
	DB	00H
	ORG $+2
TEST_Clone_X$rtcName$1 DB 06fH
	DB	00H
	ORG $+2
TEST_Clone_X$rtcName$2 DB 061H
	DB	063H
	DB	074H
	DB	075H
	DB	061H
	...
	DB	00H
	ORG $+3
TEST_Clone_X$rtcName$3 DB 061H
	DB	063H
	DB	074H
	DB	075H
	DB	061H
	...
	DB	00H
	ORG $+6
TEST_Clone_X$rtcVarDesc DD 0188H
	DD	08H
	DQ	FLAT:TEST_Clone_X$rtcName$3
	DD	070H
	DD	0100H
	DQ	FLAT:TEST_Clone_X$rtcName$2
	DD	048H
	DD	08H
	DQ	FLAT:TEST_Clone_X$rtcName$1
	DD	028H
	DD	08H
	DQ	FLAT:TEST_Clone_X$rtcName$0
	ORG $+192
TEST_Clone_X$rtcFrameData DD 04H
	DD	00H
	DQ	FLAT:TEST_Clone_X$rtcVarDesc
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File z:\sources\lunor\repos\rougemeilland\palmtree.math.core.sint\palmtree.math.core.sint\test_op_clone.c
;	COMDAT TEST_Clone_X
_TEXT	SEGMENT
x$ = 8
o$ = 40
...
$LN6@TEST_Clone:
	...
	lea	rcx, OFFSET FLAT:??_C@_1CA@CLLGGBHI@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF?$AAd?$AA?$CJ@
...
; 41   :     TEST_Assert(env, FormatTestLabel(L"Clone_X (%d.%d)", no, 2), (o_result = ep->Clone_X(x, &o)) == PMC_STATUS_OK, FormatTestMesssage(L"Clone_Xの復帰コードが期待通りではない(%d)", o_result));
	...
	jmp	SHORT $LN8@TEST_Clone
$LN7@TEST_Clone:
	mov	DWORD PTR tv91[rbp], 0
$LN8@TEST_Clone:
	mov	edx, DWORD PTR o_result$[rbp]
	lea	rcx, OFFSET FLAT:??_C@_1DG@CCIPFPD@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AAn?$PP?$KJ?$AA0?$PP?$LD?$PP?$PM?$PP?I?$AAL?$AA?$BP@
	call	FormatTestMesssage
...
; 43   :     TEST_Assert(env, FormatTestLabel(L"Clone_X (%d.%d)", no, 4), _EQUALS_MEMORY(actual_o_buf, actual_o_buf_size, desired_o_buf, desired_o_buf_size) == 0, L"データの内容が一致しない");
	...
	call	_EQUALS_MEMORY
	test	eax, eax
	jne	SHORT $LN11@TEST_Clone
	mov	DWORD PTR tv157[rbp], 1
	jmp	SHORT $LN12@TEST_Clone
$LN11@TEST_Clone:
