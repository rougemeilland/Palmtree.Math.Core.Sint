...
TEST_ParseDN2$rtcName$1 DB 06fH
	...
	DB	00H
	ORG $+8
TEST_ParseDN2$rtcVarDesc DD 088H
	DD	034H
...
TEST_ParseDN1$rtcName$1 DB 06fH
	...
	DB	00H
	ORG $+8
TEST_ParseDN1$rtcVarDesc DD 088H
	DD	034H
...
str$ = 440
styles$ = 448
desired_result_code$ = 456
desired_buf$ = 464
desired_buf_size$ = 472
...
styles$ = 448
group_separator$ = 456
decimal_separator$ = 464
positive_sign$ = 472
negative_sign$ = 480
desired_result_code$ = 488
desired_buf$ = 496
desired_buf_size$ = 504
