...
$LN6@TEST_Clone:
	...
	push	ecx
	push	OFFSET ??_C@_1CI@HEENINPI@?$AAP?$AAM?$AAC?$AA_?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AA?5?$AA?$CI?$AA?$CF?$AAd@
...
$LN8@TEST_Clone:
	...
	push	ecx
	push	OFFSET ??_C@_1DO@KAMAINPL@?$AAP?$AAM?$AAC?$AA_?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AAn?$PP?$KJ?$AA0?$PP?$LD@
	call	_FormatTestMesssage
	add	esp, 8
	push	eax
