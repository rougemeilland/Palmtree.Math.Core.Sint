...
$LN6@TEST_Clone:
	...
	push	ecx
	push	OFFSET ??_C@_1CA@CLLGGBHI@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF?$AAd?$AA?$CJ@
...
$LN8@TEST_Clone:
	...
	push	ecx
	push	OFFSET ??_C@_1DG@CCIPFPD@?$AAC?$AAl?$AAo?$AAn?$AAe?$AA_?$AAX?$AAn?$PP?$KJ?$AA0?$PP?$LD?$PP?$PM?$PP?I?$AAL?$AA?$BP@
	call	_FormatTestMesssage
	add	esp, 8
	push	eax
...
; 48   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN18@TEST_Clone
