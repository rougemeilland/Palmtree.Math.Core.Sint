...
; File z:\sources\lunor\repos\rougemeilland\palmtree.math.core.sint\palmtree.math.core.sint\dllmain.c
;	COMDAT _DllMain@12
_TEXT	SEGMENT
tv64 = -208						; size = 4
_result$ = -8						; size = 4
...
; 35   : {
	...
	rep stosd
	mov	ecx, OFFSET __C5C8A224_dllmain@c
