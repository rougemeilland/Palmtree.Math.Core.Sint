	...
	.text
Ltext0:
	.def	__ZERO_MEMORY_32;	.scl	3;	.type	32;	.endef
__ZERO_MEMORY_32:
LFB4188:
...
L6:
	...
	cmpb	$0, -28(%ebp)
	jns	L8
	.loc 3 135 41 discriminator 1
	movl	-16(%ebp), %eax
	andl	$2, %eax
	.loc 3 135 32 discriminator 1
	testl	%eax, %eax
	je	L8
	.loc 3 135 32 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	L9
L8:
	.loc 3 135 32 discriminator 4
	movl	$0, %eax
L9:
	.loc 3 135 32 discriminator 6
	andl	$1, %eax
	.loc 3 135 21 is_stmt 1 discriminator 6
	movl	8(%ebp), %edx
	andl	$1, %eax
	leal	0(,%eax,8), %ecx
	movzbl	16(%edx), %eax
	...
	orl	%ecx, %eax
	movb	%al, 16(%edx)
	.loc 3 136 26 discriminator 6
	cmpb	$0, -28(%ebp)
	jle	L10
	.loc 3 136 35 discriminator 1
	movl	-16(%ebp), %eax
	andl	$2, %eax
	.loc 3 136 26 discriminator 1
	testl	%eax, %eax
	je	L10
	.loc 3 136 26 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	L11
L10:
	.loc 3 136 26 discriminator 4
	movl	$0, %eax
L11:
	.loc 3 136 26 discriminator 6
	andl	$1, %eax
	.loc 3 136 15 is_stmt 1 discriminator 6
	movl	8(%ebp), %edx
	andl	$1, %eax
	leal	0(,%eax,4), %ecx
	movzbl	16(%edx), %eax
	...
	orl	%ecx, %eax
	movb	%al, 16(%edx)
	.loc 3 137 35 discriminator 6
	cmpb	$0, -28(%ebp)
	jle	L12
	.loc 3 137 44 discriminator 1
	movl	-16(%ebp), %eax
	andl	$16, %eax
	.loc 3 137 35 discriminator 1
	testl	%eax, %eax
	je	L12
	.loc 3 137 35 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	L13
L12:
	.loc 3 137 35 discriminator 4
	movl	$0, %eax
L13:
	.loc 3 137 35 discriminator 6
	andl	$1, %eax
	.loc 3 137 24 is_stmt 1 discriminator 6
	movl	8(%ebp), %edx
	andl	$1, %eax
	sall	$5, %eax
	movl	%eax, %ecx
	...
	orl	%ecx, %eax
	movb	%al, 16(%edx)
	.loc 3 138 24 discriminator 6
	movl	-16(%ebp), %eax
	andl	$1, %eax
	.loc 3 138 36 discriminator 6
	testl	%eax, %eax
	setne	%dl
	.loc 3 138 16 discriminator 6
	movl	8(%ebp), %eax
	andl	$1, %edx
	leal	(%edx,%edx), %ecx
	movzbl	16(%eax), %edx
	...
	orl	%ecx, %edx
	movb	%dl, 16(%eax)
	.loc 3 140 8 discriminator 6
	cmpb	$0, -28(%ebp)
	je	L14
	.loc 3 140 19 discriminator 1
	movl	8(%ebp), %eax
	movzbl	16(%eax), %eax
	andl	$2, %eax
	testb	%al, %al
...
LFB4239:
	...
	cmpl	$0, 8(%ebp)
	je	L29
	.loc 3 178 21 discriminator 1
	movl	8(%ebp), %eax
	movzbl	16(%eax), %eax
	andl	$1, %eax
	.loc 3 178 18 discriminator 1
	testb	%al, %al
	je	L29
	.loc 3 180 5
	movl	8(%ebp), %eax
...
LFB4241:
	...
	cmpl	$1231244656, %eax
	jne	L36
	.loc 3 194 121 discriminator 1
	movl	8(%ebp), %eax
	movl	4(%eax), %eax
	.loc 3 194 117 discriminator 1
	cmpl	$1951287667, %eax
	je	L37
L36:
	.loc 3 195 16
...
Letext0:
	...
	.file 18 "C:/GNU/MINGW64/i686-8.1.0-win32-dwarf-rt_v6-rev0/mingw32/i686-w64-mingw32/include/combaseapi.h"
	...
	.file 32 "Z:/Sources/Lunor/Repos/rougemeilland/Palmtree.Math.Core.Uint/Palmtree.Math.Core.Uint/pmc.h"
...
Ldebug_info0:
	...
	.byte	0
	.uleb128 0x33
	.ascii "_ZERO_MEMORY_32\0"
	.byte	0x1
	.byte	0x61
	.byte	0x1a
	.long	LFB4188
	.long	LFE4188-LFB4188
	.uleb128 0x1
	.byte	0x9c
	.long	0x6316
	.uleb128 0x2a
