...
LFE74:
	...
	.align 4
LC2:
	.ascii "P\0M\0C\0_\0S\0I\0N\0T\0_\0I\0n\0i\0t\0i\0a\0l\0i\0z\0e\0 \0f\0a\0i\0l\0e\0d\0\12\0\0\0"
	.align 2
LC3:
	.ascii "x\0"
	.ascii "8\0"
...
LFB77:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.61164, (%esp)
	movl	__imp__wsprintfW, %eax
	call	*%eax
LVL7:
	.loc 1 124 12
	movl	$_buffer.61164, %eax
	.loc 1 125 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LFB78:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.61169, (%esp)
	movl	__imp__wsprintfW, %eax
	call	*%eax
LVL8:
	.loc 1 131 12
	movl	$_buffer.61169, %eax
	.loc 1 132 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LBE2:
	...
	.cfi_endproc
LFE79:
.lcomm _buffer.61164,512,32
.lcomm _buffer.61169,512,32
Letext0:
	...
	.file 33 "../pmc_sint_debug.h"
	.file 34 "C:/GNU/MINGW64/i686-8.1.0-win32-dwarf-rt_v6-rev0/mingw32/i686-w64-mingw32/include/winuser.h"
...
LASF10:
	...
	.def	_TEST_autogenerated;	.scl	2;	.type	32;	.endef
