...
LVL1:
	...
	.cfi_endproc
LFE73:
	.def	_DoTest;	.scl	3;	.type	32;	.endef
_DoTest:
LFB74:
	.loc 1 56 1
	.cfi_startproc
	...
	movl	8(%ebp), %eax
	movl	%eax, (%esp)
	call	_TEST_autogenerated_1
	.loc 1 60 5
	movl	12(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	8(%ebp), %eax
	movl	%eax, (%esp)
	call	_TEST_autogenerated_2
	.loc 1 61 5
	movl	8(%ebp), %eax
	movl	%eax, (%esp)
	call	_TEST_End
...
LFE74:
	...
	.align 4
LC2:
	.ascii "S\0I\0N\0T\0_\0I\0n\0i\0t\0i\0a\0l\0i\0z\0e\0 \0f\0a\0i\0l\0e\0d\0\12\0\0\0"
	.align 2
LC3:
	.ascii "x\0"
	.ascii "8\0"
...
LFB77:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.61959, (%esp)
	movl	__imp__wsprintfW, %eax
	call	*%eax
LVL7:
	.loc 1 125 12
	movl	$_buffer.61959, %eax
	.loc 1 126 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LFB78:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.61964, (%esp)
	movl	__imp__wsprintfW, %eax
	call	*%eax
LVL8:
	.loc 1 132 12
	movl	$_buffer.61964, %eax
	.loc 1 133 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LC11:
	...
	.ascii "2\0x\0\0\0"
	.text
	.globl	_DumpBinary_UNIT
	.def	_DumpBinary_UNIT;	.scl	2;	.type	32;	.endef
_DumpBinary_UNIT:
LFB79:
	.loc 1 136 1
	.cfi_startproc
...
L16:
	...
	cmpl	$0, 12(%ebp)
	je	L17
	.loc 1 141 30 discriminator 1
	movl	12(%ebp), %eax
	leal	-1(%eax), %edx
	movl	-12(%ebp), %eax
	addl	%edx, %eax
	movzbl	(%eax), %eax
	.loc 1 141 26 discriminator 1
	testb	%al, %al
	je	L18
L17:
	.loc 1 143 12
...
LBE2:
	...
	.cfi_endproc
LFE79:
.lcomm _buffer.61959,512,32
.lcomm _buffer.61964,512,32
Letext0:
	...
	.file 31 "Z:/Sources/Lunor/Repos/rougemeilland/Palmtree.Math.Core.Uint/Palmtree.Math.Core.Uint/pmc_internal.h"
	...
	.file 35 "../pmc_sint_debug.h"
	.file 36 "C:/GNU/MINGW64/i686-8.1.0-win32-dwarf-rt_v6-rev0/mingw32/i686-w64-mingw32/include/winuser.h"
...
LASF32:
	...
	.def	_TEST_autogenerated_1;	.scl	2;	.type	32;	.endef
	.def	_TEST_autogenerated_2;	.scl	2;	.type	32;	.endef
