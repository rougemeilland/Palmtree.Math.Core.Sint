...
LVL5:
	...
	.loc 2 48 81
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61903, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61902, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 49 71
	movl	_actual_buf_size.61903, %eax
	movl	52(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	48(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61902, (%esp)
...
LVL13:
	...
	.loc 2 72 81
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61919, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61918, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 73 71
	movl	_actual_buf_size.61919, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61918, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 73 9
	testl	%eax, %eax
	sete	%al
...
L14:
	...
	.cfi_endproc
LFE73:
.lcomm _actual_buf.61902,256,32
.lcomm _actual_buf_size.61903,4,4
.lcomm _actual_buf.61918,256,32
.lcomm _actual_buf_size.61919,4,4
Letext0:
