...
LC3:
	...
	.text
	.globl	_TEST_ParseDN1
	.def	_TEST_ParseDN1;	.scl	2;	.type	32;	.endef
_TEST_ParseDN1:
LFB72:
...
LVL5:
	...
	.loc 2 47 81
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61943, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61942, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 48 71
	movl	_actual_buf_size.61943, %eax
	movl	52(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	48(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61942, (%esp)
...
LC4:
	...
	.text
	.globl	_TEST_ParseDN2
	.def	_TEST_ParseDN2;	.scl	2;	.type	32;	.endef
_TEST_ParseDN2:
LFB73:
	.loc 2 55 1
	.cfi_startproc
...
LVL9:
	...
	.loc 2 66 81
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61959, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61958, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL10:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 67 71
	movl	_actual_buf_size.61959, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61958, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 67 9
	testl	%eax, %eax
	sete	%al
...
LC6:
	...
	.text
	.globl	_TEST_ParseDN3
	.def	_TEST_ParseDN3;	.scl	2;	.type	32;	.endef
_TEST_ParseDN3:
LFB74:
	.loc 2 74 1
	.cfi_startproc
...
LVL13:
	...
	.loc 2 85 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61975, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61974, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 86 75
	movl	_actual_buf_size.61975, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61974, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 86 9
	testl	%eax, %eax
	sete	%al
...
L18:
	...
	.cfi_endproc
LFE74:
.lcomm _actual_buf.61942,256,32
.lcomm _actual_buf_size.61943,4,4
.lcomm _actual_buf.61958,256,32
.lcomm _actual_buf_size.61959,4,4
.lcomm _actual_buf.61974,256,32
.lcomm _actual_buf_size.61975,4,4
Letext0:
