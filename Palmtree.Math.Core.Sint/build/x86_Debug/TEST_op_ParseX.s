...
LC8:
	...
	.text
	.globl	_TEST_ParseX
	.def	_TEST_ParseX;	.scl	2;	.type	32;	.endef
_TEST_ParseX:
LFB72:
...
LVL5:
	...
	.loc 2 48 79
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61899, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61898, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 49 69
	movl	_actual_buf_size.61899, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61898, (%esp)
...
L10:
	...
	.cfi_endproc
LFE72:
.lcomm _actual_buf.61898,256,32
.lcomm _actual_buf_size.61899,4,4
Letext0:
