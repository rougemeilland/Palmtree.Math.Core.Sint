...
.Ltext0:
	...
	.def	_COPY_MEMORY_64;	.scl	3;	.type	32;	.endef
	.seh_proc	_COPY_MEMORY_64
_COPY_MEMORY_64:
.LFB4309:
...
.lcomm initialized,4,4
	.def	CopyUINTEntryPointStructure;	.scl	3;	.type	32;	.endef
	.seh_proc	CopyUINTEntryPointStructure
CopyUINTEntryPointStructure:
.LFB4364:
...
.LC1:
	...
	.text
	.def	LoadUINTLIbrary;	.scl	3;	.type	32;	.endef
	.seh_proc	LoadUINTLIbrary
LoadUINTLIbrary:
.LFB4365:
	.loc 3 61 1
	.cfi_startproc
...
.L23:
	...
	movq	-8(%rbp), %rax
	movq	%rax, %rdx
	leaq	ep_uint(%rip), %rax
	movq	%rax, %rcx
	call	CopyUINTEntryPointStructure
	.loc 3 121 9
	movq	-8(%rbp), %rax
	movq	%rax, %rdx
	leaq	entry_points(%rip), %rcx
	call	CopyUINTEntryPointStructure
	.loc 3 123 13
...
.Letext0:
	...
	.file 36 "C:/GNU/MINGW64/x86_64-8.1.0-win32-seh-rt_v6-rev0/mingw64/x86_64-w64-mingw32/include/winbase.h"
	.file 37 "C:/GNU/MINGW64/x86_64-8.1.0-win32-seh-rt_v6-rev0/mingw64/x86_64-w64-mingw32/include/libloaderapi.h"
