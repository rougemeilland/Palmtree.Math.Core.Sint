...
.LVL5:
	...
	.loc 2 48 81
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84930(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84929(%rip), %rdx
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 2 48 9
	...
	call	TEST_Assert
	.loc 2 49 71
	movq	actual_buf_size.84930(%rip), %rax
	movq	120(%rbp), %rcx
	movq	112(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84929(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 49 9
	testl	%eax, %eax
	sete	%al
...
.LVL13:
	...
	.loc 2 72 81
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84946(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84945(%rip), %rdx
	call	*%rax
.LVL14:
	movl	%eax, -8(%rbp)
	.loc 2 72 9
	...
	call	TEST_Assert
	.loc 2 73 71
	movq	actual_buf_size.84946(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84945(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 73 9
	testl	%eax, %eax
	sete	%al
...
.LFE4275:
	.seh_endproc
.lcomm actual_buf.84929,256,32
.lcomm actual_buf_size.84930,8,8
.lcomm actual_buf.84945,256,32
.lcomm actual_buf_size.84946,8,8
.Letext0:
