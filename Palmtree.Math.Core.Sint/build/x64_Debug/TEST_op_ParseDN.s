...
.LFE4273:
	...
	.align 8
.LC0:
	.ascii "T\0r\0y\0P\0a\0r\0s\0e\0n0\251_0^\263"
	.ascii "0\374"
	.ascii "0\311"
	...
	.align 8
.LC1:
	.ascii "P\0a\0r\0s\0e\0D\0N\0"
	.ascii "1\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.align 8
.LC2:
...
.LC3:
	...
	.text
	.globl	TEST_ParseDN1
	.def	TEST_ParseDN1;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_ParseDN1
TEST_ParseDN1:
.LFB4274:
	.file 2 "../TEST_op_ParseDN.c"
	.loc 2 32 1
	.cfi_startproc
	pushq	%rbp
	.seh_pushreg	%rbp
...
.LVL5:
	...
	.loc 2 47 81
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84970(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84969(%rip), %rdx
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 2 47 9
	...
	call	TEST_Assert
	.loc 2 48 71
	movq	actual_buf_size.84970(%rip), %rax
	movq	120(%rbp), %rcx
	movq	112(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84969(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 48 9
	testl	%eax, %eax
	sete	%al
...
.LC4:
	.ascii "P\0a\0r\0s\0e\0D\0N\0"
	.ascii "2\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.text
	.globl	TEST_ParseDN2
	.def	TEST_ParseDN2;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_ParseDN2
TEST_ParseDN2:
.LFB4275:
	.loc 2 55 1
	.cfi_startproc
...
.LVL9:
	...
	.loc 2 66 81
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84986(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84985(%rip), %rdx
	call	*%rax
.LVL10:
	movl	%eax, -8(%rbp)
	.loc 2 66 9
	...
	call	TEST_Assert
	.loc 2 67 71
	movq	actual_buf_size.84986(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84985(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 67 9
	testl	%eax, %eax
	sete	%al
...
.LC5:
	...
	.align 8
.LC6:
	.ascii "P\0M\0C\0_\0P\0a\0r\0s\0e\0D\0N\0"
	.ascii "3\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.text
	.globl	TEST_ParseDN3
	.def	TEST_ParseDN3;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_ParseDN3
TEST_ParseDN3:
.LFB4276:
	.loc 2 74 1
	.cfi_startproc
...
.LVL13:
	...
	.loc 2 85 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.85002(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.85001(%rip), %rdx
	call	*%rax
.LVL14:
	movl	%eax, -8(%rbp)
	.loc 2 85 9
	...
	call	TEST_Assert
	.loc 2 86 75
	movq	actual_buf_size.85002(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.85001(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 86 9
	testl	%eax, %eax
	sete	%al
...
.LFE4276:
	.seh_endproc
.lcomm actual_buf.84969,256,32
.lcomm actual_buf_size.84970,8,8
.lcomm actual_buf.84985,256,32
.lcomm actual_buf_size.84986,8,8
.lcomm actual_buf.85001,256,32
.lcomm actual_buf_size.85002,8,8
.Letext0:
