...
.LFB4279:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.84899(%rip), %rcx
	movq	__imp_wsprintfW(%rip), %rax
	call	*%rax
.LVL7:
	.loc 1 124 12
	leaq	buffer.84899(%rip), %rax
	.loc 1 125 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFB4280:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.84904(%rip), %rcx
	movq	__imp_wsprintfW(%rip), %rax
	call	*%rax
.LVL8:
	.loc 1 131 12
	leaq	buffer.84904(%rip), %rax
	.loc 1 132 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFE4281:
	.seh_endproc
.lcomm buffer.84899,512,32
.lcomm buffer.84904,512,32
.Letext0:
