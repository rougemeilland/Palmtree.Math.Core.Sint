...
.LFB4279:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.84986(%rip), %rcx
	movq	__imp_wsprintfW(%rip), %rax
	call	*%rax
.LVL7:
	.loc 1 125 12
	leaq	buffer.84986(%rip), %rax
	.loc 1 126 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFB4280:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.84991(%rip), %rcx
	movq	__imp_wsprintfW(%rip), %rax
	call	*%rax
.LVL8:
	.loc 1 132 12
	leaq	buffer.84991(%rip), %rax
	.loc 1 133 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFE4281:
	.seh_endproc
.lcomm buffer.84986,512,32
.lcomm buffer.84991,512,32
.Letext0:
	...
	.file 36 "C:/GNU/MINGW64/x86_64-8.1.0-win32-seh-rt_v6-rev0/mingw64/x86_64-w64-mingw32/include/winuser.h"
...
.LASF32:
	...
	.def	TEST_autogenerated_1;	.scl	2;	.type	32;	.endef
	.def	TEST_autogenerated_2;	.scl	2;	.type	32;	.endef
