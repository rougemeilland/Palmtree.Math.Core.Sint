...
.LC0:
	...
	.align 2
.LC1:
	.ascii "P\0a\0r\0s\0e\0X\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.align 8
.LC2:
...
.LC3:
	...
	.text
	.globl	TEST_ParseX
	.def	TEST_ParseX;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_ParseX
TEST_ParseX:
.LFB4274:
...
.LVL1:
	...
	.loc 2 43 79
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84966(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84965(%rip), %rdx
	call	*%rax
.LVL2:
	movl	%eax, -8(%rbp)
	.loc 2 43 9
	...
	call	TEST_Assert
	.loc 2 44 69
	movq	actual_buf_size.84966(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84965(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 44 9
	testl	%eax, %eax
	sete	%al
...
.LFE4274:
	.seh_endproc
.lcomm actual_buf.84965,256,32
.lcomm actual_buf_size.84966,8,8
.Letext0:
