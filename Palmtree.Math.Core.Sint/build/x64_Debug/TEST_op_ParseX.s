...
.LVL5:
	...
	.loc 2 48 79
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84926(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84925(%rip), %rdx
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 2 48 9
	...
	call	TEST_Assert
	.loc 2 49 69
	movq	actual_buf_size.84926(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84925(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 49 9
	testl	%eax, %eax
	sete	%al
...
.LFE4274:
	.seh_endproc
.lcomm actual_buf.84925,256,32
.lcomm actual_buf_size.84926,8,8
.Letext0:
